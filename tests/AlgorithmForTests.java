...
public class AlgorithmForTests extends Thread {

    final Data data;
    List < String > prevGeneration = new ArrayList < >();
    List < String > nextGeneration = new ArrayList < >();
    long[] best20Costs = new long[20];
    int[] best20Ids = new int[20];

    long bestIndividualCost = 100000000;

    public boolean work = true;
    public String bestIndividual = null;

    AlgorithmForTests(Data data) {
        this.data = data;
    }
